...
* [Files and attachments](handling-files-and-attachments.md)
  * [Handling CSV](features/handling-csv-files.md)
  * [Handling JSON](features/handling-json.md)
  * [Handling XML](features/handling-xml.md)  
  * [Handling SOAP](features/handling-soap.md)
  * [Handling YAML](features/handling-yaml.md)
  * [Handling binary files](features/handling-binary-files.md)
...
* [Teams and collaboration](user-accounts-and-teams/team-collaboration.md)
  ...
  * [SAML Just-In-Time provisioning](/user-accounts-and-teams/just-in-time-provisioning.md)
    * [Configuring JIT provisioning for custom roles](/user-accounts-and-teams/just-in-time-provisioning.md#configure-saml-attribute-on-saml-provider)
...
* [On-prem connectivity](on-prem.md)
...
* [Key features](features.md)
  ...
  * [Audit log streaming](job-history-replication.md)
  ...
  * [Callable recipes](features/callable-recipes.md)
     * [Walk-through](features/callable-recipes/walk-through.md)
     * [New call for recipe trigger](features/callable-recipes/new-call-trigger.md)
     * [Call recipe actions](features/callable-recipes/call-recipe-action.md)
     * [Return response from recipe action](features/callable-recipes/return-response-action.md)
...
* [Connectors](connectors.md)
  ...
  * [Dialogflow](/connectors/dialogflow.md)
  ...
  * [Google BigQuery](connectors/bigquery.md)
    * [Connection setup](connectors/bigquery.md#how-to-connect-to-bigquery-on-workato)
    * [New rows trigger](connectors/bigquery/new-row-trigger.md)
    * [Insert rows action](connectors/bigquery/insert.md)
    * [Select rows action](connectors/bigquery/select.md)
  ...
  * [Salesforce](connectors/salesforce.md)
    ...
    * [Real-time trigger setup](connectors/salesforce/salesforce-real-time.md)
    * [Object triggers](connectors/salesforce/salesforce-generic.md)
    * [Handling attachments](connectors/salesforce/salesforce-generic.md#attachments-in-salesforce)
    * [Using SOQL](connectors/salesforce/salesforce-soql.md)
    * [Bulk data imports](connectors/salesforce/salesforce-bulk.md)
  ...
  * [SFTP](connectors/sftp.md)
      * [New/updated file trigger](connectors/sftp/updated-file-trigger.md)
      * [New/updated CSV file trigger](connectors/sftp/updated-csv-trigger.md)
  ...
  * [Webhooks](connectors/workato-webhooks.md)
    * [Setup using wizard](connectors/workato-webhooks/wizard.md)
    * [Configuration options](connectors/workato-webhooks/config.md)
  ...
  * [Workday REST](connectors/workday-rest.md)
    * [Connection setup](connectors/workday-rest/connection-setup.md)
    * [New worker](connectors/workday-rest/new-worker-trigger.md)
    * [Get worker by ID](connectors/workday-rest/get-worker-action.md)
    * [Search workers](connectors/workday-rest/search-worker-action.md)
    * [Create a job change](connectors/workday-rest/create-job-change-action.md)
    * [Get inbox task(s)](connectors/workday-rest/get-inbox-tasks-action.md)
    * [Approve/reject inbox task](connectors/workday-rest/approve-reject-inbox-task-action.md)
  * [Wrike](/connectors/wrike.md)
    * [Connection setup](/connectors/wrike.md#how-to-connect-to-Wrike-on-Workato)
    * [New comment trigger](/connectors/wrike/new-comment-trigger.md)
    * [New/updated folder trigger](/connectors/wrike/updated-folder-trigger.md)
    * [New/updated project trigger](/connectors/wrike/updated-project-trigger.md)
    * [New/updated timelog trigger](/connectors/wrike/updated-timelog-trigger.md)
    * [Create comment action](/connectors/wrike/create-comment-action.md)
    * [Create folder action](/connectors/wrike/create-folder-action.md)
    * [Create project action](/connectors/wrike/create-project-action.md)
    * [Create task action](/connectors/wrike/create-task-action.md)
    * [Create timelog action](/connectors/wrike/create-timelog-action.md)
    * [Copy folder action](/connectors/wrike/copy-folder-action.md)
    * [Copy project ation](/connectors/wrike/copy-project-action.md)
    * [Get folder by ID action](/connectors/wrike/get-folder-by-id-action.md)
    * [Get task by ID action](/connectors/wrike/get-task-by-id-action.md)
    * [Search folders action](/connectors/wrike/search-folders-action.md)
    * [Search projects action](/connectors/wrike/search-projects-action.md)
    * [Search tasks action](/connectors/wrike/search-tasks-action.md)
    * [Search timelogs action](/connectors/wrike/search-timelogs-action.md)
    * [Update folder action](/connectors/wrike/update-folder-action.md)
    * [Update project action](/connectors/wrike/update-project-action.md)
    * [Update task action](/connectors/wrike/update-task-action.md)
    * [Update timelog action](/connectors/wrike/update-timelog-action.md)
  * [Zendesk](connectors/zendesk.md)
    * [Connection setup](connectors/zendesk.md#how-to-connect-to-zendesk-on-workato)
    * [Triggers](connectors/zendesk/trigger-summary.md)
    ...
    * [Create actions](connectors/zendesk/create-action-summary.md)
    ...
    * [Get actions](connectors/zendesk/get-action-summary.md)
    ...
    * [Update actions](connectors/zendesk/update-action-summary.md)
    ...
    * [Delete actions](connectors/zendesk/delete-action-summary.md)
...
* [Developing connectors](developing-connectors.md)
  ...
  * [HTTP connector](developing-connectors/http-v2.md)
    * [Connection setup](developing-connectors/http/connection-setup.md)
...
* [Connector SDK](developing-connectors/sdk.md)
  ...
  * [Object definitions - Picklists](/developing-connectors/sdk/pick-list.md)
  ...
  * [Advanced connector guide](developing-connectors/cookbook/introduction.md)
    * [Connector planning](developing-connectors/cookbook/connector-planning.md)
    * [Architecture](developing-connectors/cookbook/connector-building-defining-schema.md)
    * [Actions](developing-connectors/cookbook/connector-building-building-actions.md)
    * [Triggers](developing-connectors/cookbook/connector-building-building-triggers.md)
    * [Common code patterns](developing-connectors/cookbook/connector-building-code-patterns.md)
    * [Usability rules](developing-connectors/cookbook/connector-building-usability-rules.md)
...
* [Workato API](workato-api.md)
    * [Connector API](workato-api/adapters.md)
        * [List Connector Metadata](workato-api/adapters.md#list-connector-metadata)
    * [Connections API](workato-api/connections.md)
        * [List Connections](workato-api/connections.md#list-connections)
    * [Jobs API](workato-api/jobs.md)
        * [List jobs from a recipe](workato-api/jobs.md#list-jobs-from-a-recipe)
    * [Managed Users API](workato-api/managed-users.md)
        * [Create new OEM customer](workato-api/managed-users.md#create-customer-account)
        * [Get customer account](workato-api/managed-users.md#get-customer-account)
        * [Upgrading a customer account](workato-api/managed-users.md#upgrade-customer-account)
        * [Downgrading a customer account](workato-api/managed-users.md#downgrade-customer-account)
        * [Add member to OEM customer account](workato-api/managed-users.md#add-member-customer-account)
        * [Remove member from customer account](workato-api/managed-users.md#remove-member-from-customer-account)
        * [Get list of customer connections](workato-api/managed-users.md#list-customer-connections)
    * [Recipes API](workato-api/recipes.md)
        * [Get recipe details](workato-api/recipes.md#get-recipe-details)
        * [Create recipe](workato-api/recipes.md#create-a-recipe)
        * [Update recipe](workato-api/recipes.md#update-a-recipe)
        * [List recipes](workato-api/recipes.md#list-recipes-belonging-to-user)
        * [Search public recipes](workato-api/recipes.md#search-for-public-recipes)
        * [Start recipe](workato-api/recipes.md#start-recipe)
        * [Stop recipe](workato-api/recipes.md#stop-recipe)
        * [Delete recipe](workato-api/recipes.md#delete-recipe)
    * [Users](workato-api/users.md)
        * [Get user details](workato-api/users.md#get-user-details)
    * [Recipe lifecycle management](workato-api/recipe-lifecycle-management.md)
        * [Export package](workato-api/recipe-lifecycle-management.md#export-package-based-on-a-manifest)
        * [Import package](workato-api/recipe-lifecycle-management.md#import-package-into-a-folder)
        * [Get package by ID](workato-api/recipe-lifecycle-management.md#get-package-by-id)
        * [Download package](workato-api/recipe-lifecycle-management.md#download-package)
* [Security](security.md)
  * [IP whitelists](security/ip-whitelists.md)
  * [Two-factor authentication](security/two-factor-authentication.md)
  * [Data protection](security/data-protection.md)
    * [Data retention](security/data-protection/hour-data-retention.md)
    * [Encryption key management](security/data-protection/encryption-key-management.md)
