...
> </code></pre>
>
> 3. After this is done, create a new trigger that finds the next value in the sequence <code>seq_auto_increment</code> and use that as the new key
>
> <pre><code style="display: block; white-space: pre-wrap;">CREATE OR REPLACE TRIGGER id_on_insert
...
>
> 1. Enter the following commands to create an <code>updated_at</code> column, where [your_table_name] is a placeholder for your table name
>       
> <pre><code style="display: block; white-space: pre-wrap;">ALTER TABLE [your_table_name]
...
>       
> <pre><code style="display: block; white-space: pre-wrap;">create trigger trg_[your_table_name]update on [your_table_name] for update as
> begin
