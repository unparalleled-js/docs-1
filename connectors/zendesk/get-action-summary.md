---
title: Workato connectors - Zendesk get action summary
date: 2019-06-21 18:00:00 Z
search:
    keywords: ['zendesk', 'action', 'get']
---

# Zendesk - Get action summary
This section contains documentation on the get actions supported on the Workato platform, including:
- [Search tickets](connectors/zendesk/search-tickets-action.md)
...
- [Search users](connectors/zendesk/search-users-action.md)
...
- [Search organizations](connectors/zendesk/search-organizations-action.md)
