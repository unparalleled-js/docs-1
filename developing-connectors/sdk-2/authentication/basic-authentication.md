...
In connection objects, you'll be able to define the input fields in the `fields` object array. Each object in the array represents a single input field. Inside, you'll be able to declare the name of the input field, hints that are displayed to the end user amongst other parameters.
