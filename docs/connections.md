...
![Unconnected Salesforce action](~@img/recipes/connections/unconnected-salesforce-action.png)
...
![Example recipe](~@img/recipes/connections/example-recipe.png)
...
![Unconnected Salesforce](~@img/recipes/connections/unconnected-salesforce.png)
...
![Salesforce connection popup](~@img/recipes/connections/salesforce-connection-popup.png)
...
![Connected Salesforce](~@img/recipes/connections/connected-salesforce.png)
...
![Secondary Salesforce connections](~@img/recipes/connections/primary-secondary-connectors.gif)
...
![Secondary Salesforce connections](~@img/recipes/connections/secondary-app-connections.png)
