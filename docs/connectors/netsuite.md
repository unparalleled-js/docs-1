...
To carry out a get all standard object action, we would first need to tell the recipe exactly what standard object category and what specific object you want to retrieve. Filtering this list of records can be done using formula mode and `where` filters. [Find out more here](/formulas/array-list-formulas.html#where)
