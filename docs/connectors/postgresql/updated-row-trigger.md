...
![New/updated row trigger](~@img/postgresql/new-updated-row-trigger.png)
...
![New/updated batch of rows trigger](~@img/postgresql/new-updated-batch-of-rows-trigger.png)
