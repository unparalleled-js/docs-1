...
![Configured Salesforce connection](~@img/salesforce-docs/salesforce-new-connection.png)
...
![Salesforce authorization pop-up](~@img/salesforce-docs/salesforce-authentication.png)
...
![API enabled permission - profile setup](~@img/salesforce-docs/api-enabled-permission.png)
...
![Salesforce standard object permissions - profile setup](~@img/salesforce-docs/standard-object-profile-permissions.png)
*Salesforce standard object profile permissions setup*

![Salesforce custom object permissions - profile setup](~@img/salesforce-docs/custom-object-profile-permissions.png)
...
![Salesforce platform events permissions - profile setup](~@img/salesforce-docs/platform-events-permissions.png)
...
![Salesforce custom domains](~@img/salesforce-docs/customize-application-permission.png)
*Use a custom domain*
...
![Salesforce Communities custom domains](~@img/salesforce-docs/customize-application-permission.png)
