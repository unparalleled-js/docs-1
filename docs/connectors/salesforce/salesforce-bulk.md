...
![Salesforce bulk create via CSV file action sections](~@img/salesforce-docs/bulk-create-action-sections.png)
...
![Salesforce bulk action - configured CSV file input section](~@img/salesforce-docs/bulk-action-csv-file-input-section.png)
...
![Salesforce bulk operation output datatree](~@img/salesforce-docs/bulk-operation-datatree.gif)
...
![Salesforce bulk operation output datatree - aggregated results across bulk jobs](~@img/salesforce-docs/bulk-operation-datatree-aggregate-numbers.png)
...
![Salesforce bulk operation output datatree - list of bulk jobs](~@img/salesforce-docs/bulk-operation-datatree-array-of-jobs.png)
...
![Configured Salesforce bulk retry action](~@img/salesforce-docs/configured-bulk-retry-action.png)
...
![Sample recipe - Salesforce bulk upsert via CSV file](~@img/salesforce-docs/sample-bulk-upsert-recipe.png)
...
![Configured Salesforce bulk upsert action](~@img/salesforce-docs/configured-bulk-upsert-action.png)
...
![If condition checking for any failed records](~@img/salesforce-docs/if-condition-for-successful-bulk-jobs.png)
...
![Configured retry bulk operation action](~@img/salesforce-docs/configured-retry-object-bulk-job-in-sample-recipe.png)
