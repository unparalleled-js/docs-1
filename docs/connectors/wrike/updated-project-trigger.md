...
![New/updated project trigger](~@img/connectors/wrike/updated-project-trigger.png)
*New/updated project trigger*
...
![New/updated project trigger(real time)](~@img/connectors/wrike/updated-project-trigger-real-time.png)
*New/updated project trigger (real time)*
