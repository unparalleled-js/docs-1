...
![Selecting the custom action](~@img/developing-connectors/custom-actions/custom-action-selection.png)
...
![App scopes available for the custom action](~@img/developing-connectors/custom-actions/app-scopes.png)
...
![Scope error returned by the API when call is made](~@img/developing-connectors/custom-actions/custom-action-scope-error-output.png)
...
![Select the Slack custom action](~@img/developing-connectors/custom-actions/select-slack-custom-action.png)
...
![Naming your custom action](~@img/developing-connectors/custom-actions/name-custom-action.gif)
...
![Slack's API documentation for list channels](~@img/developing-connectors/custom-actions/slack-list-channels-http-method-docs.png)
*Slack's API documentation for list channels*

Once selected, relevant input fields show up in the action for you to fill.

![Additional fields show up when you select HTTP method](~@img/developing-connectors/custom-actions/select-http-method.gif)
...
![Adding URL endpoint for list channels](~@img/developing-connectors/custom-actions/add-url-endpoint.png)
...
![Slack API documentation on arguments for list channel endpoint](~@img/developing-connectors/custom-actions/slack-docs-list-channel-arguments.png)
...
![Adding URL params for the custom action](~@img/developing-connectors/custom-actions/add-custom-action-params.gif)
...
![Filling in values for params](~@img/developing-connectors/custom-actions/fill-in-param-values.gif)
...
![Generate output datatree in Workato with JSON response sample in API documentation](~@img/developing-connectors/custom-actions/generate-output-schema.gif)
...
![Generated output datatree in Workato](~@img/developing-connectors/custom-actions/generated-output-datatree.gif)
...
![Completed Slack custom action to list channels](~@img/developing-connectors/custom-actions/full-slack-custom-action.gif)
...
![Job history - input data](~@img/developing-connectors/custom-actions/list-channels-action-input.png)
...
![Job history - output showing channel data returned](~@img/developing-connectors/custom-actions/list-channels-action-output.png)
