...
![HTTP (OAuth2) connector's connection fields](~@img/http/connector-connection-fields.png)
...
![Eventbrite OAuth2 authentication page](~@img/http/eventbrite-authentication.png)
...
![Completed Eventbrite connection](~@img/http/complete-eventbrite-connection.png)
...
![HTTP connector authentication type: None](~@img/http/http-connector-type.png)
...
![HTTP connector authentication type: Basic](~@img/http/http-connector-basic.png)
...
![HTTP connector authentication type: Heade auth](~@img/http/http-connector-head.png)
...
![HTTP connector authentication type: query params](~@img/http/http-connnector-query.png)
*HTTP connector authentication type: Query params*

### Custom
Custom simply allows you to use a combination of any of the above fields.
![Custom http connector](~@img/http/http-connector-custom.jpg)
...
![Configured http action](~@img/http/configured-action.png)
...
![Sent Api Request](~@img/http/sent-api-request.png)
...
![Configured http action](~@img/http/API-recieved.png)
...
![HTTP connector's webhook trigger](~@img/http/http-webhook-trigger.png)
...
![Configured Web Hook](~@img/http/configured-webhook.png)
*Example of a configured webhook trigger*

![trigger datatree](~@img/http/trigger-datatree.png)
...
![Configuring webhook](~@img/http/configuring-webhook-trigger.png)
...
![Configuring Webhook](~@img/http/creating-a-webhook.png)
...
![Job details output](~@img/http/job-details-output.png)
...
![Building the Workato datatree by defining webhook payload](~@img/http/building-datatree-with-payload.gif)
...
![Manage Webhook](~@img/http/request-payload.png)
...
![Configured webhook trigger](~@img/http/configured-web-hook-trigger.png)
...
![Webhook datatree](~@img/http/webhook-trigger-datatree.png)
*Webhook datatree*
...
![REST input fields](~@img/http/input-fields-request.png)

![REST input fields 2](~@img/http/input-fields.png)
...
![Partially configure GET](~@img/http/partially-configured-GET.png)
...
![API order](~@img/http/order-api-call.png)
...
![configured GET action](~@img/http/configured-action.png)
*Configured GET action*

![configured GET action](~@img/http/response-body.png)
*Configured GET action*

![datatree](~@img/http/data-tree-body.png)
...
![unconfigured http](~@img/http/unconfigured-http.png)

![unconfigured http](~@img/http/unconfigured.png)
...
![configured JIRA](~@img/http/configured-jira-project.png)

![configured JIRA](~@img/http/configured-request.png)
...
![generated data tree](~@img/http/generated-data-tree.png)
...
![complete recipe](~@img/http/complete-recipe.png)
...
![sample job](~@img/http/sample-job.png)
