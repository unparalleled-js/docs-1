...
![Example Trigger IF recipe](~@img/features/trigger-conditions/example-trigger-if-recipe.png)
...
![Example conditional step recipe](~@img/features/trigger-conditions/conditional_step_examples.png)
...
![Auto-retry condition](~@img/features/trigger-conditions/retry-condition.png)
...
![Example contains recipe](~@img/features/trigger-conditions/example-contains-recipe.png)
...
![Example starts with recipe](~@img/features/trigger-conditions/example-starts-with-recipe.png)
...
![Comparing number types for starts with condition](~@img/features/trigger-conditions/comparing-number-types-starts-with-condition.png)
...
![Comparing number types for starts with condition](~@img/features/trigger-conditions/string-conversion-starts-with-condition.png)
...
![Example ends with recipe](~@img/features/trigger-conditions/example-ends-with-recipe.png)
...
![Comparing number types for starts with condition](~@img/features/trigger-conditions/comparing-number-types-ends-with-condition.png)
*Comparing number types for ends with condition will throw a trigger error*

However, if the trigger data input field is a non-string datapill, and the value is a string, Workato converts the datapill's value into a string value for you and does the comparison, evaluating to true if the converted value meets the condition.

![Comparing number types for starts with condition](~@img/features/trigger-conditions/string-conversion-ends-with-condition.png)
*Non-string datapills will be converted to a string for comparison if value is a string*
...
![Example doesn't contain recipe](~@img/features/trigger-conditions/example-doesnt-contain-recipe.png)
...
![Example doesn't start with recipe](~@img/features/trigger-conditions/example-doesnt-start-with-recipe.png)
...
![Comparing number types for starts with condition](~@img/features/trigger-conditions/comparing-number-types-doesnt-start-with-condition.png)
*Comparing number types for doesn't start with condition will throw a trigger error*

However, if the trigger data input field is a non-string datapill, and the value is a string, Workato converts the datapill's value into a string value for you and does the comparison, evaluating to true if the converted value meets the condition.

![Comparing number types for starts with condition](~@img/features/trigger-conditions/string-conversion-doesnt-start-with-condition.png)
*Non-string datapills will be converted to a string for comparison if value is a string*
...
![Example doesn't end with recipe](~@img/features/trigger-conditions/example-doesnt-end-with-recipe.png)
...
![Comparing number types for starts with condition](~@img/features/trigger-conditions/comparing-number-types-doesnt-end-with-condition.png)
*Comparing number types for doesn't end with condition will throw a trigger error*

However, if the trigger data input field is a non-string datapill, and the value is a string, Workato converts the datapill's value into a string value for you and does the comparison, evaluating to true if the converted value meets the condition.

![Comparing number types for starts with condition](~@img/features/trigger-conditions/string-conversion-doesnt-end-with-condition.png)
*Non-string datapills will be converted to a string for comparison if value is a string*
...
![Example equals recipe](~@img/features/trigger-conditions/example-equals-recipe.png)
...
![Example does not equal recipe](~@img/features/trigger-conditions/example-doesnt-equal-recipe.png)
...
![Example is greater than recipe](~@img/features/trigger-conditions/example-is-greater-than-recipe.png)
...
![Example is present and greater than recipe](~@img/features/trigger-conditions/example-is-present-and-greater-than-recipe.png)
...
![Example is less than recipe](~@img/features/trigger-conditions/example-is-less-than-recipe.png)
...
![Example is true recipe](~@img/features/trigger-conditions/example-is-true-recipe.png)
...
![Example boolean recipe](~@img/features/trigger-conditions/example-boolean-recipe.png)
...
![Example is not true recipe](~@img/features/trigger-conditions/example-is-not-true-recipe.png)
...
![Example is present recipe](~@img/features/trigger-conditions/example-is-present-recipe.png)
...
![Example is not present recipe](~@img/features/trigger-conditions/example-is-not-present-recipe.png)
