...
![Defining expected CSV columns](~@img/features/list-management/defining-expected-csv-columns.gif)
...
![CSV columns in trigger output](~@img/features/list-management/csv-columns-in-trigger-output.gif)
...
![List datatree icon](~@img/features/list-management/list-datatree-icon.png)
...
![Example recipe using list pills directly](~@img/features/list-management/example-recipe-using-list-pills-directly.png)
*Recipe using list pills directly in Log message action. [Example recipe](https://www.workato.com/recipes/487919)*

![Field mappings for log message](~@img/features/list-management/field-mappings-for-log-message.gif)
...
![CSV trigger output](~@img/features/list-management/csv-trigger-output.png)
...
![Log message result](~@img/features/list-management/log-message-result.png)
...
![Example recipe using list input](~@img/features/list-management/example-recipe-using-input-list.png)
...
![Mapping list data pills to list](~@img/features/list-management/mapping-list-datapills-to-list.gif)
...
![Salesforce bulk insert via input list](~@img/features/list-management/job-output-sf-bulk-insert.png)
...
![Example recipe using repeat step](~@img/features/list-management/example-recipe-using-repeat-step.png)
...
![Repeat step input list](~@img/features/list-management/repeat-step-input-list.png)
...
![Mapping from foreach datatree](~@img/features/list-management/mapping-from-foreach-datatree.gif)
...
![Recipe with direct mapping from list](~@img/features/list-management/recipe-with-wrong-direct-mapping.gif)
...
![Empty accumulator](~@img/features/list-management/empty-accumulator.png)
*Accumulator with no fields configured*

Define the fields in the custom list by configuring field name, type and hint.

![Adding string field to accumulator](~@img/features/list-management/add-string-to-accumulator.png)
*Adding a string field to the accumulator list*

![Adding date field to accumulator](~@img/features/list-management/add-date-to-accumulator.png)
...
![Accumulator example](~@img/features/list-management/accumulator-example.png)
...
![Editing custom list JSON](~@img/features/list-management/editing-custom-list-json.gif)
...
![Example recipe using accumulator](~@img/features/list-management/example-recipe-using-accumulator.png)
...
![Example recipe using repeat step](~@img/features/list-management/example-recipe-using-repeat-step-vs-accumulator.png)
