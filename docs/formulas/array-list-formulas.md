...
![Simple where formula retrieving lead records from company Delphi Chemicals](~@img/formula-docs/non-nested-where-formula.png)
...
![Nested where formula retrieving lead records with an address in USA](~@img/formula-docs/nested-where-formula.png)
