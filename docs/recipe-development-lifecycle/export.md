...
![RLM in tools gif](~@img/features/packages/name-manifest.png)
...
![Marketing manifest](~@img/features/packages/manifest.png)
...
![Connection in diff folder](~@img/features/packages/dependent-asset-not-found.png)
...
![Connection in diff folder](~@img/features/packages/deselect-object.gif)
...
![Connection in diff folder](~@img/features/packages/lookup-properties.png)
...
![Download package](~@img/features/packages/download-package.gif)
...
![Export history](~@img/features/packages/export-history.png)
...
![Connection in diff folder](~@img/features/packages/missing-connection.png)
*As objects are deselected, warnings appear*
...
![Connection in diff folder](~@img/features/packages/new-changed-asset.png)
