...
![Formula Compilation Error](~@img/formula-errors/compilation_formula_error.png)
...
![Formula Runtime Error](~@img/formula-errors/formula_error_gif_1.gif)
...
![Formula Runtime Error](~@img/formula-errors/formula_error_gif_2.gif)
...
![Formula Error 3](~@img/formula-errors/formula_error_3.png)
...
![Formula Error 4](~@img/formula-errors/formula_error_4.png)
