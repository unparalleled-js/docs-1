...
![Message actions trigger](~@img/workbot/workbot-message-actions/message-actions-trigger.png)
...
![Message actions config](~@img/workbot/workbot-message-actions/message-actions-config.png)
