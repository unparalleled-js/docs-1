  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <br>
        <img src="/assets/images/security/2fa/profile-dropdown.png"></img>
    ...
    <tr>
      ...
      <td>
        ...
        <br>
        <img src="/assets/images/security/2fa/account-setting-before-activation.png"></img>
    ...
    <tr>
      <td>3</td>
      <td>
        Using Symantec VIP, <b>scan</b> the QR code or enter the code.<br>
        <br>
        <img src="/assets/images/security/2fa/setup-2fa.png"></img>
    ...
    <tr>
      ...
      <td>
        ...
        <br>
        <img src="/assets/images/security/2fa/setup-2fa-input.png"></img>
        <i>Confirming authenticator app with Workato account</i><br>
        <br>
        <img src="/assets/images/security/2fa/symantec-workato.jpg" alt="Image" height="40%" width="50%"></img><br>
        <i>Symantec VIP unique verification code</i><br>
        <br>
        The <code>Workato</code> label and <code>profile name</code> lets you know that the connection between Symantec VIP and Workato platform is functioning properly.
        </td>
    </tr>
    <tr>
      <td>5</td>
      <td>
        ...
        <br>
        <img src="/assets/images/security/2fa/setup-2fa-codes.png"></img>
    ...
    <tr>
      ...
      <td>
        Done!<br>
        <br>
        You have completed the one-time setup of your Workato two-factor authentication.<br>
        <br>
        <img src="/assets/images/security/2fa/trusted-device.png"></img>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <br>
        This will remove the <b>all trusted devices</b> that were logged in with the authenticator app.
        </td>
    </tr>
  </tbody>
</table>
